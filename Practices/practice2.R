...
# 8.trunk() - rounds to the nearest integer in the direction of 0.
trunc(125.2395) #[1] 125

# 9. append() - add elements to a vector
append(1:5, 0:1, after = 3) # [1] 1 2 3 0 1 4 5

# 10. round a number with the indicated decimals, if not indicated an integer is given
round (6.78.1)
round (11.80)
